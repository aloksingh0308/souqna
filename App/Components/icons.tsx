    ...
    return (
        <Svg xmlns="http://www.w3.org/2000/svg" width="46" height="38" viewBox="0 0 46 38">
            <G id="_6646160_add_and_car_plus_transport_icon" data-name="6646160_add_and_car_plus_transport_icon" transform="translate(0 -5)">
                ...
                <Path id="Path_3265" data-name="Path 3265" d="M10.768,23H2v2.923a2.931,2.931,0,0,0,2.923,2.923H7.846a2.931,2.931,0,0,0,2.923-2.923Z" transform="translate(0.461 7.844)" fill="none" stroke="#002e4b" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="2" />
                <Line id="Line_10" data-name="Line 10" x2="4.969" transform="translate(1 14.768)" fill="none" stroke="#002e4b" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="2" />
                <Line id="Line_11" data-name="Line 11" x2="5" transform="translate(34 14)" fill="none" stroke="#002e4b" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="2" />
                <Line id="Line_12" data-name="Line 12" x2="4" transform="translate(5 24)" fill="none" stroke="#002e4b" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="2" />
                <Ellipse id="Ellipse_246" data-name="Ellipse 246" cx="10.5" cy="11" rx="10.5" ry="11" transform="translate(24 20)" fill="none" stroke="#002e4b" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="2" />
                <Line id="Line_13" data-name="Line 13" y2="8" transform="translate(34 27)" fill="none" stroke="#002e4b" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="2" />
                <Line id="Line_14" data-name="Line 14" x2="9" transform="translate(30 31)" fill="none" stroke="#002e4b" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="2" />
                <Path id="Path_3266" data-name="Path 3266" d="M21.568,20.608A2.761,2.761,0,0,0,18.938,19H13.823a2.761,2.761,0,0,0-2.631,1.608L9,24.846" transform="translate(3.691 5.998)" fill="none" stroke="#002e4b" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="2" />
                <Path id="Path_3267" data-name="Path 3267" d="M24.383,27.614H3.923A2.931,2.931,0,0,1,1,24.691V18.846A5.863,5.863,0,0,1,6.846,13H33.151A5.883,5.883,0,0,1,39,18.407" transform="translate(0 3.23)" fill="none" stroke="#002e4b" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="2" />
            </G>
        </Svg>
...
export const FurnitureIcons = ({ color = 'red', height = 40, width = 40 }: IconProps) => {
    return (
