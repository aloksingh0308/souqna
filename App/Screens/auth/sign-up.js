                    ...
                    <View style={{ alignItems: 'center', backgroundColor: '#fff' }}>
                        ...
                        <View style={{ flexDirection: 'row', alignItems: 'center', marginVertical: '5%', width: '95%', justifyContent: 'space-around' }}>
                            <TouchableOpacity onPress={() => this.setState({ is_mark: !this.state.is_mark })}>
                                <View style={{ width: 20, height: 20, borderRadius: 5, borderWidth: 1, borderColor: colors.TEXT_COLOR, justifyContent: 'center', alignItems: 'center',backgroundColor:this.state.is_mark?colors.TEXT_COLOR:'#fff' }}>
                                    {this.state.is_mark ? (
                                        <Image source={require('../../Assets/checked.png')} style={{ width: 16, height: 16, resizeMode: 'contain', tintColor: '#fff' }} />
                                    ) : null}
                                </View>
                            </TouchableOpacity>
