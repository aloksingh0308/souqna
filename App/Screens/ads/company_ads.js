      ...
      <ScrollView >
        <SafeAreaView style={{ flex: 1, backgroundColor: '#fff', }}>
          <View style={{ width: '100%', alignItems: 'center' }}>
            <Text style={[texts.SUBHEADING_TEXT, { paddingHorizontal: '1%', paddingVertical: '5%', width: '100%' }]} >create new Company ad</Text>
            ...
            <InputBox
              ...
              styles={{ width: '100%', alignItems: 'center', marginTop: '3%' }}
            />
            <Text style={{ width: '100%', paddingVertical: '5%', paddingHorizontal: '5%' }}>Products</Text>
            <InputBox
              // multiline={true}
              // textBoxStyle={{height:60}}
              title='Product 1'
